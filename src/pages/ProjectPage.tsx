      ...
      <main className="pt-32 pb-24">
        <div className="container mx-auto px-4">
          ...
          <section className="grid lg:grid-cols-[1.15fr_0.85fr] gap-10 items-start">
            <div>
              <div className="aspect-[16/10] rounded-3xl bg-gradient-to-br from-muted to-secondary flex items-center justify-center overflow-hidden">
                <Building2 className="w-24 h-24 text-accent/30" aria-hidden="true" />
              </div>
              ...
              <div className="mt-8">
                ...
                <h1 className="font-display text-4xl md:text-6xl font-bold text-foreground mt-5 mb-4">
                  {project.name}
                </h1>
              ...
              <div className="flex flex-col gap-3 mt-7">
                <Button variant="brand" asChild>
                  <a href="https://calendly.com/jvk-aconsultancy/30min" target="_blank" rel="noopener noreferrer">
                    Book a Project Consultation <ArrowRight size={18} />
                  </a>
                </Button>
                {project.phone && (
                  <Button variant="outline" asChild>
                    <a href={`tel:${project.phone.replace(/\s+/g, "")}`}>
                      <Phone size={17} /> {project.phone}
                    </a>
                  </Button>
                )}
              </div>
          ...
          <section className="mt-16">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {project.highlights.map((highlight) => (
                <div key={highlight} className="bg-card border border-border rounded-xl p-5">
          ...
          <section className="mt-16 rounded-2xl bg-card border border-border p-8 md:p-10">
            ...
            <p className="text-muted-foreground max-w-3xl leading-relaxed mb-6">
              This project record is designed to connect project-level marketing
              with future inventory such as plots, apartments, villas or other
              units. Availability, pricing and approvals should be confirmed
              with the Anantha Real Estate team before any customer commitment.
            </p>
            <Button variant="brand" asChild>
