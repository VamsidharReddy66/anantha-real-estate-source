    ...
    <div className="min-h-screen bg-white text-slate-950 overflow-x-hidden">
      ...
      <footer className="bg-white border-t border-slate-100">
        <div className="container mx-auto px-4 py-12 grid sm:grid-cols-2 lg:grid-cols-[1.2fr_0.7fr_1fr_1.1fr] gap-10">
          ...
          <div><h3 className="text-sm font-extrabold text-[#171c42]">Contact Us</h3><div className="mt-4 grid gap-3 text-sm text-slate-500"><p className="flex items-start gap-2"><MapPin size={17} className="mt-0.5 text-[#4023a4]" /> Satyanarayana Puram Centre, Mypadu Road, Nellore, Andhra Pradesh 524002</p><a href="tel:+919391675372" className="flex items-center gap-2"><Phone size={16} className="text-[#4023a4]" /> +91 93916 75372</a><a href="mailto:jvk.aconsultancy@gmail.com" className="flex items-center gap-2"><Mail size={16} className="text-[#4023a4]" /> jvk.aconsultancy@gmail.com</a></div></div>
        </div>
